...
var MovieDetailsComponent = /** @class */ (function () {
    function MovieDetailsComponent(dialogRef, data) {
...
var MovieComponent = /** @class */ (function () {
    function MovieComponent(_movieService, dialog) {
        var _this = this;
        ...
        this._movieService.getMovies(this.currentPage).subscribe(function (data) {
            _this.movies = _this.transformURL(data);
        });
    }
    /**
     ...
     * @param filterValue
     */
    MovieComponent.prototype.applyFilter = function (filterValue) {
        var _this = this;
        if (filterValue.length !== 0) {
            this._movieService.searchMovies(this.currentPage, filterValue).subscribe(function (data) {
                _this.currentPage = 1;
                _this.length = data.total_results;
                _this.movies = data.results;
            }, function (err) { return console.log(err); }, function () {
                _this.movies = _this.transformURL(_this.movies);
            });
        }
    };
    MovieComponent.prototype.ngOnInit = function () {
    };
    MovieComponent.prototype.openDialog = function (movie_id) {
        var _this = this;
        console.log('name selected', movie_id);
        this._movieService.getMovieDetails(movie_id).subscribe(function (data) {
            console.log(data);
            data.poster_path = _this.imageURL + data.poster_path;
            _this.selectedMovie = data;
        }, function (err) { console.log(err); }, function () {
            console.log(_this.selectedMovie);
            var dialogRef = _this.dialog.open(_movie_details_movie_details_component__WEBPACK_IMPORTED_MODULE_4__["MovieDetailsComponent"], {
                width: '500px',
                data: _this.selectedMovie
            });
     ...
     * @param movies
     */
    MovieComponent.prototype.transformURL = function (movies) {
        var _this = this;
        movies.map(function (movie) {
            movie.poster_path = _this.imageURL + movie.poster_path;
            movie.backdrop_path = _this.imageURL + movie.backdrop_path;
        });
        return movies;
    };
...
var MoviesService = /** @class */ (function () {
     ...
     * @return movie
     */
    MoviesService.prototype.getMovieDetails = function (movie_id) {
     ...
     * @return movies
     */
    MoviesService.prototype.searchMovies = function (page, query) {
